...
If a component truly requires a two-dimensional layout for meaning/usage (e.g., large data tables, maps, diagrams), allow horizontal scrolling only at the component level.
