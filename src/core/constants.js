...
(function() {
  ...
  window.FoxLog.i18n = {
    ...
    executionFlow: isFrench ? 'Flux d\'exécution' : 'Execution Flow',
    ...
    rootTransaction: isFrench ? 'Transaction' : 'Transaction',
    selectedNode: isFrench ? 'Nœud sélectionné' : 'Selected node',
