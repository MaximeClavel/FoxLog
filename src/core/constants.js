...
(function() {
  ...
  window.FoxLog.i18n = {
    ...
    viewInFlow: isFrench ? 'Voir dans le flux' : 'View in Flow',
    viewInAnalysis: isFrench ? 'Voir dans l\'analyse' : 'View in Analysis',
    viewAnalysis: isFrench ? 'Voir l\'analyse' : 'View analysis',
    verdictHealthy: isFrench ? 'Log sain' : 'Healthy log',
    verdictNoErrors: isFrench ? 'Aucune erreur' : 'No errors',
    verdictErrorOne: isFrench ? '{count} erreur' : '{count} error',
    verdictErrorMany: isFrench ? '{count} erreurs' : '{count} errors',
    verdictCriticalOne: isFrench ? '{count} anti-pattern critique' : '{count} critical anti-pattern',
    verdictCriticalMany: isFrench ? '{count} anti-patterns critiques' : '{count} critical anti-patterns',
    verdictAttentionOne: isFrench ? '{count} point d\'attention' : '{count} warning',
    verdictAttentionMany: isFrench ? '{count} points d\'attention' : '{count} warnings',
    verdictStatusFailed: isFrench ? 'Le log ne s\'est pas terminé avec succès' : 'The log did not finish successfully',
    verdictLimitCritical: isFrench ? 'Une limite Salesforce est presque atteinte' : 'A Salesforce limit is almost reached',
    verdictLimitWarning: isFrench ? 'Une limite Salesforce dépasse 75 %' : 'A Salesforce limit is above 75%',
    verdictAnd: isFrench ? ' et ' : ' and ',
    viewAllAntiPatterns: isFrench ? 'Voir les {count} anti-patterns' : 'View all {count} anti-patterns',
    copyMessage: isFrench ? 'Copier le message' : 'Copy message',
    focusPrevious: isFrench ? 'Précédent' : 'Previous',
    focusNext: isFrench ? 'Suivant' : 'Next',
    closeFocus: isFrench ? 'Fermer la navigation' : 'Close navigation',
    methodTimeTitle: isFrench ? 'Temps cumulé (appels récursifs comptés une fois)' : 'Total time (recursive calls counted once)',
